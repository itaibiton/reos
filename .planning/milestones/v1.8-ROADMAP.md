...
- **v1.8 Conversion & Essential Pages** - Phases 53-56 (shipped 2026-01-29)
...
**Plans**: 3 plans
Plans:
  - [x] 53-01-PLAN.md — HowItWorks component with i18n translations (EN + HE)
  - [x] 53-02-PLAN.md — FAQ component with tabs, accordion, JSON-LD, and i18n translations (EN + HE)
  - [x] 53-03-PLAN.md — Wire both components into landing page and visual verification
