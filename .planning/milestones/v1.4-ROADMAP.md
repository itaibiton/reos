...
Plans:
- [ ] 30-01-PLAN.md — Sidebar RTL behavior (direction-aware side prop, tooltip positioning)
- [ ] 30-02-PLAN.md — UI component patches (Sheet, NavigationMenu, menus, breadcrumb, pagination, carousel)
- [ ] 30-03-PLAN.md — Application page directional icons (back buttons, forward arrows)
...
| 30 | RTL Component Patches | RTL-03, RTL-04, RTL-05 | 3 | Pending |
