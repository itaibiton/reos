...
Plans:
- [ ] 28-01-PLAN.md — i18n core setup (packages, config, middleware)
- [ ] 28-02-PLAN.md — App structure migration ([locale] segment, providers)
...
|-------|------|--------------|-------|--------|
| 28 | i18n Infrastructure | INFRA-01, INFRA-02, INFRA-03, INFRA-04, RTL-01 | 2 | Pending |
| 29 | CSS Logical Properties Migration | RTL-02 | TBD | Pending |
