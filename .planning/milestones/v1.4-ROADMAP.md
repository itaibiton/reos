...
Plans:
- [ ] 29-01-PLAN.md — Migrate high-priority Shadcn UI (sidebar, sheet, menus)
- [ ] 29-02-PLAN.md — Migrate medium-priority Shadcn UI (dialog, table, calendar)
- [ ] 29-03-PLAN.md — Migrate remaining Shadcn UI components
- [ ] 29-04-PLAN.md — Migrate layout and search components
- [ ] 29-05-PLAN.md — Migrate dashboard and property components
- [ ] 29-06-PLAN.md — Migrate chat components
- [ ] 29-07-PLAN.md — Migrate questionnaire components
- [ ] 29-08-PLAN.md — Migrate feed, profile, deals, settings components
- [ ] 29-09-PLAN.md — Migrate high-traffic application pages
- [ ] 29-10-PLAN.md — Migrate remaining pages and final verification
...
3. ESLint rule warns on new physical directional class usage
...
| 29 | CSS Logical Properties Migration | RTL-02 | 10 | Pending |
