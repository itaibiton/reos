...
must_haves:
  truths:
    ...
    - "SaveAllButton renders below property cards after auto-greeting"
    - "Providers are grouped by role (broker, mortgage_advisor, lawyer)"
    - "Provider cards have 'Add to Team' buttons"
...
4. AUTO-03: SaveAllButton renders below property cards
5. AUTO-04: Providers grouped by role with Add to Team buttons
6. SUCCESS-07: Quick reply buttons visible after auto-suggestions
</verification>
