...
@.planning/phases/57-vendor-onboarding-approval/57-02-SUMMARY.md
...
- For the "Revise & Resubmit" flow, the vendor wizard (Plan 02) detects an existing profile via getMyProfile and pre-populates the form
  </action>
  <verify>
...
- Multi-step vendor registration wizard with photo upload (Plan 02)
...
4. **Rejection flow (test with another vendor):**
   ...
   - Click "Revise & Resubmit" -- verify wizard opens with pre-filled data from Convex profile
