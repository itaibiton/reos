...
const TypingSearch = () => {
    ...
    return (
        <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-2 flex items-center gap-2 mb-3 z-20 relative">
            ...
            <div className="bg-primary rounded p-1.5 flex-shrink-0">
    ...
    const stepsData = [
                ...
                <div className="absolute inset-0 p-4 sm:p-6">
                    ...
                    <div className="w-full">
                        ...
                        <div className="flex gap-2 mt-4">
                            <div className="h-6 w-16 bg-chart-1/10 rounded-md flex items-center justify-center">
                                <div className="h-1 w-8 bg-chart-1 rounded-full"></div>
                            </div>
        ...
        },
        {
            ...
            visual: (
                ...
                <div className="relative h-full w-full p-4 overflow-hidden flex flex-col">
                    <TypingSearch />
                    <div className="grid grid-cols-2 gap-3 flex-1 overflow-hidden">
                        {/* Property Cards Mockup */}
                        {[
                            { color: "bg-chart-1", icon: "bg-chart-1/20" },
                            { color: "bg-chart-2", icon: "bg-chart-2/20" },
                            { color: "bg-chart-3", icon: "bg-chart-3/20" },
                            { color: "bg-chart-4", icon: "bg-chart-4/20" },
                        ].map((item, i) => (
                            <div key={i} className="bg-white border border-neutral-200 rounded-lg p-2 sm:p-3 shadow-sm transform transition-transform hover:-translate-y-1 flex flex-col justify-center">
        ...
        },
        {
            ...
            visual: (
                ...
                <div className="w-full h-full p-3">
                    ...
                    <div className="bg-white border border-neutral-200 rounded-lg p-3 h-full shadow-sm">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-2">
                                <div className="w-6 h-6 bg-chart-3/10 rounded-md flex items-center justify-center">
                                    <BarChart3 className="w-3 h-3 text-chart-3" />
                                </div>
                        ...
                        <div className="flex gap-2 items-end h-16 justify-center pb-2 border-b border-neutral-100">
                            <div className="w-4 bg-chart-1/40 rounded-t-sm h-8"></div>
                            <div className="w-4 bg-chart-1/60 rounded-t-sm h-12"></div>
                            <div className="w-4 bg-chart-1 rounded-t-sm h-10"></div>
                            <div className="w-4 bg-chart-1/80 rounded-t-sm h-14"></div>
                            <div className="w-4 bg-chart-2 rounded-t-sm h-12"></div>
                        </div>
    ...
    return (
        ...
        >
            ...
            STEP 1
                    ...
                    <div className="relative h-48 sm:h-56 bg-neutral-100 border border-neutral-200 overflow-hidden mb-6">
                        {stepsData[0].visual}
                    </div>

                    <h3 className="text-2xl sm:text-3xl text-neutral-900 font-sans tracking-tight leading-tight mb-3">
                        {t(`steps.${stepsData[0].key}.title`)}
                    </h3>
            ...
            STEP 3
                    ...
                    <div className="relative h-48 sm:h-56 bg-neutral-100 border border-neutral-200 overflow-hidden mb-6 p-4">
                        {stepsData[2].visual}
                    </div>

                    <h3 className="text-2xl sm:text-3xl text-neutral-900 font-sans tracking-tight leading-tight mb-3">
                        {t(`steps.${stepsData[2].key}.title`)}
                    </h3>
                    <p className="text-sm sm:text-base text-neutral-600 leading-relaxed">
